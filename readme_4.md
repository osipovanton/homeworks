### Домашняя работа «Введение в Terraform»
![alt text](image.png)
...
4.  Ошибка в строке 23:
   ```tf
resource "docker_image" {
Error: Missing name for resource
on main.tf line 23, in resource "docker_image": 23:
resource "docker_image" { All resource blocks must have 2 labels (type, name).
```
...
```
Ошибка в имени ресурса. В имени содержится и начинается на цифру "1". Исправил имя на ```"nginx"```
Далее были ошибки: 
...
```
<img width="1682" height="166" alt="Без названия" src="https://github.com/user-attachments/assets/a2ac9eed-7b45-4c80-ad4e-cb8256831acf" />
